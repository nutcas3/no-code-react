...
type BoardsProfileAScrollableRowfeedProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "feed" | "boards" | "team" | "resources"
> &
  Partial<{ feed: string; boards: string; team: string; resources: string }>;

const BoardsProfileAScrollableRowfeed: React.FC<
  BoardsProfileAScrollableRowfeedProps
> = (props) => {
  return (
    <>
...
BoardsProfileAScrollableRowfeed.defaultProps = {
  feed: "FEED",
  boards: "bOARDS",
  team: "TEAM ",
  resources: "rESOURCES",
...
export default BoardsProfileAScrollableRowfeed;
