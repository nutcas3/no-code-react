  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-grifter items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col font-plusjakartasans h-full items-center justify-start w-full">
          <div className="flex flex-col gap-4 items-start justify-start max-w-[1440px] pt-16 sm:px-5 px-8 w-full">
